...
| `REQ-11` | `IZZE6KCS` | AI/gadget use requires consent, privacy, fairness, human accountability, and limits on generalization. | Keep consent, provenance, fairness/limitations, clinician review, and privacy language visible at the relevant decision. | `H06`, `H14`, `H18-H20`, `C12-C13` | Safety, fairness, and accessibility review; clinician accountability comprehension question. |
