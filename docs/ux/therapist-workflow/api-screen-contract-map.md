...
| H10 | Follow processing | Processing slice: read status/retry | Therapist | Processing complete/partial | Not started | E01/E07/E09 | Retry only failed stage | No fabricated completion |
| H11 | Attest transcript | Transcript slice: read uncertainty/attest | Therapist | Transcript dependency attested | No usable transcript | E07/E09/E10 | Reprocess or save limitation | No local transcript source |
...
| E07 | Rebuild stale result | Processing/evidence operation | Therapist | Current dependency | Stale result excluded | `stale_result` | Reprocess current input | Never report stale result |
...
| E09 | Continue partial result | Processing operation | Therapist | Successful channels preserved | Failed channel unavailable | `partial_processing_failure` | Retry failed channel | Never fill missing channel |
